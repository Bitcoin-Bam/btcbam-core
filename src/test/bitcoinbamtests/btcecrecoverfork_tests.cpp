...
//    initState();
    ...
    std::vector<BitcoinbamTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createBitcoinbamTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createBitcoinbamTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createBitcoinbamTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createBitcoinbamTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
