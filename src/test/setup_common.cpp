...
////////////////////////////////////////////////////////////// bitcoinbam
    ...
    boost::filesystem::path pathTemp = fs::temp_directory_path() / strprintf("test_bitcoinbam_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
    boost::filesystem::create_directories(pathTemp);
    const dev::h256 hashDB(dev::sha3(dev::rlp("")));
    globalState = std::unique_ptr<BitcoinbamState>(new BitcoinbamState(dev::u256(0), BitcoinbamState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
