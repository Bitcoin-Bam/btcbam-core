...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // bitcoinbam
        hashUTXORoot.SetNull(); // bitcoinbam
    ...
    virtual bool IsProofOfStake() const //bitcoinbam
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //bitcoinbam
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //bitcoinbam
    {
