#ifndef BTCBAMDELEGATION_H
#define BTCBAMDELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
...
/**
 * @brief The IBitcoinbamStaker class Delegation filter
 */
...
/**
 * @brief The BitcoinbamDelegation class Communicate with the bitcoinbam delegation contract
 */
class BitcoinbamDelegation {
    
public:
    /**
     * @brief BitcoinbamDelegation Constructor
     */
    BitcoinbamDelegation();

    /**
     * @brief ~BitcoinbamDelegation Destructor
     */
    virtual ~BitcoinbamDelegation();
...
private:
    BitcoinbamDelegation(const BitcoinbamDelegation&);
    BitcoinbamDelegation& operator=(const BitcoinbamDelegation&);
    BitcoinbamDelegationPriv* priv;
};
#endif
