#include <bitcoinbam/bitcoinbamutils.h>
...
bool bitcoinbamutils::btc_ecrecover(const dev::h256 &hash, const dev::u256 &v, const dev::h256 &r, const dev::h256 &s, dev::h256 &key)
{
