#ifndef BTCBAMTRANSACTION_H
#define BTCBAMTRANSACTION_H
...
class BitcoinbamTransaction : public dev::eth::Transaction{

public:

    BitcoinbamTransaction() : nVout(0), hasRefundSender(false) {}

    BitcoinbamTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
        dev::eth::Transaction(_value, _gasPrice, _gas, _data, _nonce) , nVout(0), hasRefundSender(false) {}

    BitcoinbamTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::Address const& _dest, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
