...
#include "genesis/bitcoinbamMainNetwork.cpp"
...
#include "genesis/test/bitcoinbamTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::bitcoinbamMainNetwork: return c_genesisInfoBitcoinbamMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::bitcoinbamTestNetwork: return c_genesisInfoBitcoinbamTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::bitcoinbamMainNetwork: return c_genesisStateRootBitcoinbamMainNetwork;
    case Network::bitcoinbamTestNetwork: return c_genesisStateRootBitcoinbamTestNetwork;
