...
class BitcoinbamStyle : public QProxyStyle
{
public:
    BitcoinbamStyle()
    {
...
void StyleSheet::setStyleSheet(QApplication *app, const QString& style_name)
{
    ...
    BitcoinbamStyle* bitcoinbamStyle = new BitcoinbamStyle;
    bitcoinbamStyle->setBaseStyle(mainStyle);
    app->setStyle(bitcoinbamStyle);
