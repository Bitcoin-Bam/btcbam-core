#ifndef BTCBAMVERSIONCHECKER_H
#define BTCBAMVERSIONCHECKER_H

#include <QObject>

#define BTCBAM_RELEASES "https://github.com/bitcoinbamproject/bitcoinbam/releases"
...
class BitcoinbamVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit BitcoinbamVersionChecker(QObject *parent = 0);
    ~BitcoinbamVersionChecker();
