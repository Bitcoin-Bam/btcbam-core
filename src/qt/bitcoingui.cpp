    ...
    m_network_style(networkStyle)
{
    ...
    bitcoinbamVersionChecker = new BitcoinbamVersionChecker(this);
#ifdef ENABLE_WALLET
    if(enableWallet) {
...
void BitcoinGUI::createActions()
{
    ...
    BRCTokenAction = new QAction(platformStyle->MultiStatesIcon(":/icons/brctoken"), tr("&BRC Tokens"), this);
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Bitcoinbam command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::setClientModel(ClientModel *_clientModel)
{
    ...
    {
        // Check for updates
        if(_clientModel->getOptionsModel()->getCheckForUpdates() && bitcoinbamVersionChecker->newVersionAvailable())
        {
            QString link = QString("<a href=%1>%2</a>").arg(BTCBAM_RELEASES, BTCBAM_RELEASES);
            QString message(tr("New version of Bitcoinbam wallet is available on the Bitcoinbam source code repository: <br /> %1. <br />It is recommended to download it and update this application").arg(link));
