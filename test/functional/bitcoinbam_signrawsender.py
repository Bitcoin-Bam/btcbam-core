...
class BitcoinbamSignRawSenderTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Now send some bitcoinbam to both addresses (one contract will increase its balance and the other one will throw),
...
if __name__ == '__main__':
    BitcoinbamSignRawSenderTest().main()
