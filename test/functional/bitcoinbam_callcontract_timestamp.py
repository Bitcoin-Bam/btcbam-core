...
from test_framework.bitcoinbam import activate_mpos
...
class BitcoinbamCallContractTimestampTest(BitcoinTestFramework):
...
if __name__ == '__main__':
    BitcoinbamCallContractTimestampTest().main()
