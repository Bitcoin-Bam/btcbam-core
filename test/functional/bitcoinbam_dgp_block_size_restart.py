...
"""
Note, these tests do not test the functionality of the DGP template contract itself, for tests for the DGP template, see bitcoinbam-dgp.py
"""
class BitcoinbamDGPActivation(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Restart the bitcoinbamd to verify that no crashes occurs on startup
        self.stop_nodes()
        self.start_nodes()


if __name__ == '__main__':
    BitcoinbamDGPActivation().main()
