...
1. Clone the Bitcoinbam Core source code:
    ```shell
...
```shell
mkdir -p "/Users/${USER}/Library/Application Support/Bitcoinbam"

touch "/Users/${USER}/Library/Application Support/Bitcoinbam/bitcoinbam.conf"

chmod 600 "/Users/${USER}/Library/Application Support/Bitcoinbam/bitcoinbam.conf"
```

The first time you run bitcoinbamd, it will start downloading the blockchain. This process could
